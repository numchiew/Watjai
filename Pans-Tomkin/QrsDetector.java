...
public class QrsDetector {
	...
	private String root_dir="C:/Users/USER/Documents/NetBeansProjects/QRS/";
...
//	                fiducial_pt = ((right_margin+left_margin)/2)-39; 
	                ...
	                // point median filter to reset the threshold */
	                	...
	                	no_of_fids++;
                                //System.out.println("NO OF FIDS : " + no_of_fids);
	                }
	            }
	            else x--;
	        }
	...
	private long DetectQRS(double x, double y){
        ...
        private double[] rrAvg = new double[8];
		...
		while (strLineFile	!= null){
	        ...
	        if (fid_pandt > 0) /* (-1 indicates a refactory period) */
	        {
	            ...
	            heart_rate = 60.0/rr_int;
                  ...
                  double sumR = 0; //reset Avg RR every beat.
                  
                  for(int i =0;i<rrAvg.length;i++){
                      sumR += rrAvg[i];
                  }
                  sumR = sumR * 0.125; //set new RR AVG.
                  double rr = rr_int*1000;
